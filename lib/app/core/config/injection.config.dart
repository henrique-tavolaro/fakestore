...
import 'package:fakestore/app/core/network/client.dart' as _i9;
...
import 'package:fakestore/app/presentation/cubit/store_cubit.dart' as _i8;
...
_i1.GetIt init(
  ...
  gh.factory<_i4.IStoreDatasource>(() => _i5.StoreDatasource(gh<_i3.Dio>()));
  gh.factory<_i6.IStoreRepository>(
      () => _i7.StoreRepository(gh<_i4.IStoreDatasource>()));
  gh.factory<_i8.StoreCubit>(() => _i8.StoreCubit(gh<_i6.IStoreRepository>()));
  return getIt;
}
